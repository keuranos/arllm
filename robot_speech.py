...
FINNISH_PHRASES = {
    "exploring": [
        "Tutkitaanpa mitä täältä löytyy...",
        "Lähden tutkimaan.",
        "Mielenkiintoista, katson tarkemmin.",
        "Mitähän tuolla on?",
    ],
    "found_person": [
        "Hei! Näen jonkun!",
        "Moi moi! Löysin ihmisen!",
        "Aa, siellä on joku!",
        "Terve! Hauska nähdä!",
    ],
    "approaching": [
        "Menen lähemmäs...",
        "Tulen sinne päin.",
        "Odotas, katson tarkemmin.",
    ],
    "turning": [
        "Käännyn...",
        "Katson toiseen suuntaan.",
        "Hetkinen, käännän päätä.",
    ],
    "obstacle": [
        "Oho, este edessä!",
        "Täältä ei pääse, kokeilen toista suuntaa.",
        "Jotain tiellä, väistän.",
    ],
    "curious": [
        "Hmm, mitäköhän tuolla on?",
        "Tutkitaanpa...",
        "Mielenkiintoista!",
        "Uteliaana katson mitä täällä on.",
    ],
    "bored": [
        "Tylsää... pitäisikö mennä jonnekin?",
        "Ei tapahdu mitään.",
        "Voisin käydä tutkimassa muualla.",
    ],
    "found_door": [
        "Siinä on ovi!",
        "Näyttää olevan oviaukko.",
        "Toiseen huoneeseen pääsisi tuosta.",
    ],
    "entering_room": [
        "Menen sisään...",
